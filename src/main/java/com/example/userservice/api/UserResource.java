...
public class UserResource {
    ...
    public ResponseEntity<User> saveUsers(@RequestBody User user){
        //current context path is the localhost
...
//created return 201 other return 200
    ...
    public ResponseEntity<?> addRoleToUser(@RequestBody ADDROLETOUSER addroletouser){
       ...
       //created return 201 other return 200
        return ResponseEntity.ok().build();//we are not returning anything
    }
...
//@Data will be used to generate getter setters
@Data
class ADDROLETOUSER{
